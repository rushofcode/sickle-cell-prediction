...
# Inject CSS
st.markdown(f"<style>{load_file('C:/Users/dell/Downloads/Sickle-Cell-Image-main/Sickle-Cell-Image-main/Pages/style.css')}</style>", unsafe_allow_html=True)

# Inject JavaScript
st.markdown(f"<script>{load_file('C:/Users/dell/Downloads/Sickle-Cell-Image-main/Sickle-Cell-Image-main/Pages/app.js')}</script>", unsafe_allow_html=True)

# Load and Display HTML in an iframe
components.html(load_file("C:/Users/dell/Downloads/Sickle-Cell-Image-main/Sickle-Cell-Image-main/Pages/ll.html"), height=600)
...
image_path = "C:/Users/dell/Downloads/Sickle-Cell-Image-main/Sickle-Cell-Image-main/blood2.jpg"  # Replace with your actual image path
